/**
 * A React context for managing WebSocket connections.
 * Provides a WebSocket connection (socket) and manages multiple channels (channels) for real-time communication.
 * 
 * subscribe to events
 */
